			...
			<span class="l-col-12">
				...
				if ( have_rows( $team_member_identifier ) ) : 
					...
					while ( have_rows( $team_member_identifier ) ) : the_row(); ?>
						...
						<div class="l-col-12 l-col-sml-6<?php if ( $i % 2 == 0 ) : ?>-last<?php endif; ?> l-col-med-4<?php if ( $i % 3 == 0 ) : ?>-last<?php endif; ?>">

							<?php if ( $team_member_photo ) : ?>
								<img src="<?php echo $team_member_photo['url']; ?>"/>
							<?php endif; ?>

							<h2><?php the_sub_field( 'acf_team_member_name' ); ?></h2>
							<span class="u-b"><?php the_sub_field( 'acf_team_member_blurb' ); ?></span>
							...
							if ( have_rows( $social_links_identifier ) ) : 
								...
								<a href="<?php the_sub_field( 'acf_team_member_social_url' ); ?>"><?php the_sub_field( 'acf_team_member_social_text' ); ?></a>
